...
ui_proc_buttons <- column(4, 
     ...
     bsButton("removeHeader", icon=icon("angle-double-up"), label = "", style="primary", type="toggle", value=FALSE ),
     bsTooltip("resizeView", "Enlarge or Shrink the image height", "bottom", options = list(container = "body")),
     bsTooltip("removeHeader", "Enable / Disable the banner and the main tabs", "bottom", options = list(container = "body")),
     tags$br(), tags$br(),
     tags$br(), tags$br(),
