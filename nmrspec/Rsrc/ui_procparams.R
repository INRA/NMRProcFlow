     ...
     column(9,
         ...
         conditionalPanel(condition="input.tpreproc=='calibration'",
              ...
              column(4,
                  ...
                  bsTooltip("calibtype", "Select the signal shape. Calibration is done on the maximum value (singlet) or the central value (doublet)", "top", options = list(container = "body"))
              ),
              column(4,
